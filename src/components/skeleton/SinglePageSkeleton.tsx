...
const SinglePageSkeleton = () => {
  return (
    <div className="space-y-12 animate-in fade-in duration-500">
      ...
      <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] items-start rounded-3xl border border-gray-100 bg-white shadow-sm shadow-gray-900/5 p-6 sm:p-8">
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 3 }).map((_, index) => (
            <Card key={index} className="pt-0 gap-0 overflow-hidden border-none shadow-sm">
