...
function About() {
  return (
    <div className="text-center md:text-left p-10 grid md:grid-cols-[calc(100%-60%)_auto] grid-cols-1 gap-6">
      ...
      <div className="flex flex-col items-center md:items-start justify-start">
        ...
        <div className="text-center md:text-left">
          <h2 className="text-yellow-500 text-2xl sm:text-3xl mb-2">Welcome To Marcelino’s</h2>
          <p className="text-[15px] sm:text-[16px] text-neutral-800 leading-relaxed max-w-[600px] mx-auto md:mx-0">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-5 mt-8 w-full">
            ...
            {/* Card 1 */}
            <Card className="flex-1 min-w-[220px] max-w-[300px] text-center bg-neutral-200 text-neutral-900 shadow-md shadow-gray-500/40 rounded-2xl transition-transform hover:scale-105 hover:bg-green-800 hover:text-white">
              <CardHeader>
                <div className="flex justify-center items-center mb-2">
                  <img src={diamond} alt="diamond svg" className="w-10 h-auto" />
                </div>
            ...
            <Card className="flex-1 min-w-[220px] max-w-[300px] text-center bg-neutral-200 text-neutral-900 shadow-md shadow-gray-500/40 rounded-2xl transition-transform hover:scale-105 hover:bg-green-800 hover:text-white">
              <CardHeader>
                <div className="flex justify-center items-center mb-2">
                  <img src={wine} alt="wine toast svg" className="w-10 h-auto" />
                </div>
                <CardTitle className="text-lg font-semibold">
                  Elegant<br/>Gatherings
                </CardTitle>
                <p className="text-sm mt-2">
            ...
            <Card className="flex-1 min-w-[220px] max-w-[300px] text-center bg-neutral-200 text-neutral-900 shadow-md shadow-gray-500/40 rounded-2xl transition-transform hover:scale-105 hover:bg-green-800 hover:text-white">
              <CardHeader>
                <div className="flex justify-center items-center mb-2">
                  <img src={handshake} alt="handshake svg" className="w-10 h-auto" />
                </div>
                <CardTitle className="text-lg font-semibold">
                  Refined<br/>Hospitality
                </CardTitle>
                <p className="text-sm mt-2">
